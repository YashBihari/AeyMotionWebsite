...
const projects = [
  {
    ...
    description: "Designed a clean kinetic film modeling self-organizing autonomous agents. Focused on seamless vector grid paths, isolated LLM execution states, and pristine 3D canvas choreography to turn complex code architecture into high-end brand assets as a personal showcase of specialized motion design skills. [personal project]",
  ...
  },
  {
    ...
    description: "Designed a clean, highly energetic motion experience highlighting Hostinger's website builder features, focusing on rapid workflow transitions and micro-interactions as part of a personal showcase of visual marketing skills. [personal project]",
  ...
  },
  {
    ...
    description: "Engineered rich visual storytelling of multi-signature secure pipelines and token routing animations, mapping dense developer setups to pristine responsive kinetic boards to showcase dynamic interface design skills. [personal project]",
  ...
  },
  {
    ...
    description: "An optimization exploration focusing on vector weight choreography, reactive frame interpolation, and playful spring physics presets designed for modern web apps as a personal exploration in advanced micro-interaction skills. [personal project]",
  ...
  },
  {
    ...
    description: "Built high-fidelity 3D and 2D vector graphic layouts mapping security filters, isolated model contexts, and fine-tuning pipelines into an editorial film style designed to showcase advanced motion design skills. [personal project]",
